...
| 🌒 **L2 · Waxing Crescent** | Frontend integration | ✅ React UI wired to the contract; **Lace** connector; contract deployed and verifiable on **Preview** |
...
| 🌔 **L4 · Waxing Gibbous** | MVP goes live | 🔄 both contracts live on **Preview** and proved from the demo itself; still to do — public product profile on **X** |
| 🌕 **L5 · Full Moon** | Users & feedback | Living feedback loop + **50 Preview users** running real polls |
...
- **L4 → L5:** on-chain writes from the browser, which needs a Lace build whose connector matches
  a published midnight-js — see [deploy-lace/README.md](deploy-lace/README.md) for why that is not
  possible today.
